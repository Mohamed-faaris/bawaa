      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-3">
            ...
            <div
              className={`w-2.5 h-2.5 rounded-full ${staff.status === "active" ? "bg-success" : "bg-muted-foreground"}`}
            />
          ...
          <tbody>
            {staff.recentDeliveries.map((d) => (
              ...
              >
                ...
                <td className="p-4">
                  <span
                    className={`text-xs font-semibold px-2.5 py-1 rounded-full ${deliveryStatusStyles[d.status] || "bg-muted text-muted-foreground"}`}
                  >
                    {d.status}
                  </span>
                </td>
