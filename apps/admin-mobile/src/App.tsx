...
const NavigationBars = () => {
  ...
  const isAdminMobile =
    path.startsWith("/admin-mobile") && path !== "/admin-mobile/login";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          />
          <Route
            path="/admin-mobile/alerts"
            element={<AdminMobileAlertsPage />}
          />
