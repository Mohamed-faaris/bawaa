...
const apps = [
  {
    icon: Smartphone,
    label: "Customer App",
    desc: "Upload prescriptions, manage profiles, track orders",
    path: "/login",
  ...
  },
  {
    icon: Truck,
    label: "Delivery App",
    desc: "Accept deliveries, update status, view routes",
    path: "/delivery/login",
  ...
  },
  {
    icon: Shield,
    label: "Admin Mobile",
    desc: "Quick order monitoring and status updates",
  ...
  },
  {
    icon: Monitor,
    label: "Admin Panel",
    desc: "Full dashboard with analytics and reports",
    path: "/panel",
    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-lg w-full">
        {apps.map((app, i) => (
          ...
          >
            <div
              className={`w-12 h-12 rounded-xl ${app.color} flex items-center justify-center mb-3`}
            >
              <app.icon size={22} />
            </div>
